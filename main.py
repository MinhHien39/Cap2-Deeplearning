...
def main():
    ...
    train_dataset = EnhancedDataset(
        image_dir="dataYOLO2/images/train", 
        label_dir="dataYOLO2/labels/train",
        yolo_transform=yolo_transform,
        cnn_transform=cnn_transform
    )
    
    val_dataset = EnhancedDataset(
        image_dir="dataYOLO2/images/val", 
        label_dir="dataYOLO2/labels/val",
        yolo_transform=yolo_transform,
        cnn_transform=cnn_transform
    )
    
    test_dataset = EnhancedDataset(
        image_dir="dataYOLO2/images/test", 
        label_dir="dataYOLO2/labels/test",
        yolo_transform=yolo_transform,
        cnn_transform=cnn_transform
    )
